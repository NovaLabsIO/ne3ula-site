<svelte:head>
  <title>E3 — NE3ULA</title>
  <meta name="viewport" content="width=device-width,initial-scale=1" />
  <meta name="description" content="The NE3ULA E3 placeholder page." />
</svelte:head>

<main class="wrap">
  <div class="card e3-card">
    ...
    <div class="nav">
      ...
      <span class="btn nav-current" aria-current="page">E3</span>
    </div>
  </div>
</main>
