<svelte:head>
  <title>LORE — NE3ULA</title>
  <meta name="viewport" content="width=device-width,initial-scale=1" />
  <meta name="description" content="The NE3ULA lore placeholder page." />
</svelte:head>
...
<main class="wrap">
  <div class="card lore-card">
    ...
    <h1>LORE</h1>
    <p>Placeholder content. Replace with final experience.</p>

    <div class="nav">
      <a class="btn" href="/home">HOME</a>
      <a class="btn" href="/music">MUSIC</a>
      <span class="btn nav-current" aria-current="page">LORE</span>
      <a class="btn" href="/axzio">AXZIO</a>
      <a class="btn" href="/e3">E3</a>
    </div>
  </div>
</main>
